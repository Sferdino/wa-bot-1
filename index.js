    ...
    sock.ev.on('messages.upsert', async ({ messages, type }) => {
        ...
        if (type === 'notify' && !messages[0].key.fromMe) {
            try {
                ...
                const isMessageMentionBot = incomingMessages.includes('@6283151547260');
                ...
                if (!isMessageFromGroup) {
                    ...
                    } else if (incomingMessages === 'hi') {
                        await sock.sendMessage(senderNumber, { text: 'halo!' }, { quoted: messages[0] }, 2000);
                    } else if (incomingMessages === 'halo') {
                        await sock.sendMessage(senderNumber, { text: 'hi!' }, { quoted: messages[0] }, 2000);
                    } else {
                        async function main() {
